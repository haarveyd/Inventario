...
public class ProductosRecyclerAdaptator extends RecyclerView.Adapter<ProductosRecyclerAdaptator.ViewHolder> {


    private Cursor cursorListaProductos;
    private OnItemClickListener listenerClick;

    public ProductosRecyclerAdaptator(OnItemClickListener listenerClick) {
